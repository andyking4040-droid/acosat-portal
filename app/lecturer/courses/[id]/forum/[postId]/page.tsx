...
export default async function LecturerForumPostPage({
  params,
}: {
  ...
  if (!post || post.courseId !== params.id || post.course.lecturerId !== lecturer.id) {
    notFound();
  }
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="bg-white border-b border-slate-200 sticky top-0 z-10">
          <div className="px-4 sm:px-6 lg:px-8 py-4">
            <Link
              href={`/lecturer/courses/${params.id}/forum`}
