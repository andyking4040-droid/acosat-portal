            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 pr-12 rounded-xl border border-slate-200 bg-slate-50 focus:bg-white focus:border-navy-500 focus:ring-2 focus:ring-navy-500/20 outline-none transition"
                />
                <button
                  type="button"
